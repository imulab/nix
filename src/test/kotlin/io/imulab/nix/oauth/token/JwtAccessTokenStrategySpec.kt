...
import io.imulab.nix.client.Client
...
import io.imulab.nix.support.getScopes
...
object JwtAccessTokenStrategySpec: Spek({
    ...
    describe("generate new token") {
        ...
        it("should pass verification") {
            val verified = strategy.verifyToken(mock(), JwtToken(TokenType.AccessToken, rawToken))
