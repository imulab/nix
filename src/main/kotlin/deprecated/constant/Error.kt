package deprecated.constant

import deprecated.crypt.alg.SigningAlgorithm
import deprecated.error.InvalidRequestException
import deprecated.error.InvalidRequestObjectException
import deprecated.error.OAuthException
...
object Error {
    ...
    object Jwk {
        ...
        fun notFoundForSignature() = InvalidRequestException(
            notFound,
            "Failed to locate a json web key for signature operation."
        )
        fun notFoundForEncryption() = InvalidRequestException(
            notFound,
            "Failed to locate a json web key for encryption operation."
        )
        fun algorithmMismatch(must: SigningAlgorithm) =
            InvalidRequestObjectException(
                algMismatch,
                "JWT is signed with an algorithm different than a registered one. Expects: ${must.alg}"
            )
        fun noneAlgorithmAtAuthorizeEndpoint() =
            InvalidRequestException(
                algMismatch,
                "It is illegal to use <none> algorithm to sign id_token to be returned at authorization endpoint."
            )
    }
    ...
    object Jwks {
        ...
        fun invalid() = InvalidRequestException(
            invalid,
            "Json web key set is invalid."
        )
        fun noJwks() = InvalidRequestException(
            noResolve,
            "Failed to resolve a json web key set for further operation."
        )
    }
    ...
    object State {
        ...
        fun missing(): OAuthException = InvalidRequestException(
            missing,
            "${Param.STATE} is missing."
        )
        fun entropy(): OAuthException = InvalidRequestException(
            entropy,
            "${Param.STATE} does not have sufficient entropy."
        )
    }
    ...
    object RedirectUri {
        ...
        fun noneRegistered(): OAuthException = InvalidRequestException(
            none,
            "Cannot select ${Param.REDIRECT_URI}: none was registered."
        )
        fun multipleRegistered(): OAuthException = InvalidRequestException(
            multiple,
            "Cannot select ${Param.REDIRECT_URI}: multiple registered."
        )
        fun rouge(): OAuthException = InvalidRequestException(
            rouge,
            "Cannot select ${Param.REDIRECT_URI}: provided value not registered."
        )
        fun invalid(): OAuthException = InvalidRequestException(
            invalid,
    ...
    object Oidc {
        ...
        fun futureAuthTime() = InvalidRequestException(
            futureAuthTime,
            "Authentication time cannot be in the future."
        )
        fun noAuthTime() = InvalidRequestException(
            noAuthTime,
            "Missing authentication time. Authentication time must be present when max age is present."
        )
        fun noRequestTime() = InvalidRequestException(
            noReqTime,
            "Missing request time. Request time must be present when max age is present."
        )
        fun nonePromptNotStandalone() = InvalidRequestException(
            invalidPrompt,
            "Prompt <${Prompt.None.specValue}> cannot be accompanied by other prompts."
        )

        fun loginRequired() = InvalidRequestException(
            authExpired,
            "TODO change this to login_required"
        )    // TODO
        fun reLoginRequired() = InvalidRequestException(
            authExpired,
            "TODO change this to login_required"
        )    // TODO
    }
    ...
    object RequestObject {
        ...
        fun acquireFailed() = InvalidRequestObjectException(
            acquire,
            "Failed to acquire request object."
        )
    }
    ...
    object AccessToken {
        ...
        fun badFormat() = InvalidRequestException(
            format,
            "Malformed access token. Must be a valid Json Web Token."
        )
        fun expired() = InvalidRequestException(
            expired,
            "Access token has expired."
        )
        fun badSignature() = InvalidRequestException(
            signature,
            "Access token has illegal signature."
        )
        fun verifyFailed(t: Throwable) = InvalidRequestException(
            verify,
            "Access token failed verification: ${t.localizedMessage}"
        )
        fun notFound() = InvalidRequestException(
            notFound,
            "Access token not found in record."
        )
        fun inactive() = InvalidRequestException(
            inactive,
    ...
    object AuthorizeCode {
        ...
        fun badFormat() = InvalidRequestException(
            format,
            "Malformed authorize code."
        )
        fun badSignature() = InvalidRequestException(
            signature,
            "Authorize code has illegal signature."
        )
        fun notFound() = InvalidRequestException(
            notFound,
            "Authorize code not found in record."
        )
        fun expired() = InvalidRequestException(
            expired,
            "Authorize code has expired."
        )
        fun inactive() = InvalidRequestException(
            inactive,
            "Authorize code has been deactivated."
        )
    }
    ...
    object RefreshToken {
        ...
        fun badSignature() = InvalidRequestException(
            signature,
            "Refresh token has illegal signature."
        )
        fun notFound() = InvalidRequestException(
            notFound,
            "Refresh token not found in record."
        )
        fun expired() = InvalidRequestException(
            expired,
        ...
        fun inactive() = InvalidRequestException(
            inactive,
            "Refresh token has been deactivated."
        )
    }
}